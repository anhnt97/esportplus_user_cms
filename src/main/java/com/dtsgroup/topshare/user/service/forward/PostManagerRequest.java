...
@WebServlet(name = "create-post-manager", urlPatterns = {"/create-post-manager"})
public class PostManagerRequest extends PostForwardRequest {
    @Override
    public String getRequestUrl() {
        return baseUrl() + "/post-manager/create";
    }
    @Override
