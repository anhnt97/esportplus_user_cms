 ...
 * @author daua1993
 */
@WebServlet(name = "unlock-bet-table", urlPatterns = {"/unlock-bet-table"})
public class UnLockBetTableRequest extends PostForwardRequest {

    @Override
    public String getRequestUrl() {
        return baseUrl() + "/bet-table/unlock";
    }
