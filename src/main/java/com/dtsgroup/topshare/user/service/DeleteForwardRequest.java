 ...
 * @author daua1993
 */
public abstract class DeleteForwardRequest extends ForwardRequest {
    ...
    public JSONObject executeRequest(Map<String, String> params) {
        JSONObject json = HttpUtils.deleteData(getRequestUrl(), paramsJson);
        return json;
    }
    ...
    protected Map<String, String> getParams(HttpServletRequest request) throws UnsupportedEncodingException {
        ...
        paramsJson.put("adminId", username);
        if (params == null) {
            params = new HashMap<>();
        }
        params.clear();
