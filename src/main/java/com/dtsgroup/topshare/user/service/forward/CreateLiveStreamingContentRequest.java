...
@WebServlet(name = "livestreaming-create", urlPatterns = {"/livestreaming-create"})
public class CreateLiveStreamingContentRequest extends PostForwardRequest {

    @Override
    public String getRequestUrl() {
        return baseUrl() + "/post/livepost/create";
    }
