 ...
 * @author daua1993
 */
@WebServlet(name = "updateresult", urlPatterns = {"/updateresult"})
public class UpdateBetResultRequest extends PostForwardRequest {

    @Override
    public String getRequestUrl() {
        return baseUrl() + "/bet-match/updateresult";
    }
