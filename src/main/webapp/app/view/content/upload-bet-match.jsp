...
<mt:masterpage title="Upload Bet Match">
    <jsp:attribute name="content">
        <div id="upload-posts-manager-app">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Add New Bet Match</h1>
                </div>
            </div>
            <div style="padding-left: 30px">
                <div class="row" style="margin-top: 20px">
                        ...
                        <div class="row">
                            <div class="col-sm-8">
                                ...
                                <input class="form-control" type="text" id="game_mode" placeholder="Game mode"
                                       maxlength="50" size="20" v-model="create_request.game_mode"
                                >
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class=" col-sm-8" v-for="(linkstream, index) in list_link_stream">
                                <label>Link Stream {{index+1}}</label>
                                <input class="form-control" type="text" id="input_link" placeholder="Link Stream"
                                       maxlength="200" size="20" v-model="linkstream.link"
                                >
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div>
                                    <div class="row">
                                        <div>
                                            <img style="display: none" id="thumbnail-news" src="#"
                                                 alt="your image"/><br/>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-sm-4">
                                ...
                                <select style="width: auto" class="form-control" v-model.number="create_request.set"
                                        id="set_select">
                            ...
                            <div class="col-sm-4">
                                ...
                                <select style="width: auto" class="form-control" v-model.number="create_request.match"
                                        id="match_select">
                                    <option value="1" selected>1</option>
                                    <%--<option value="2">2</option>--%>
                                    <%--<option value="3">3</option>--%>
                            ...
                            <div class="col-sm-4">
                                ...
                                <select style="width: auto" class="form-control"
                                        v-model.number="create_request.state_select" id="state_select">
                            ...
                            <div class="col-sm-8">
                                <label>Choose Bet Mode</label>
                                <div class="form-group" id="bet-mode" style="max-height: 150px; overflow-y: auto">

                                    <span v-for="bet_mode in bet_modes" class="col-lg-6 col-md-3 col-sm-6 col-xs-6">
                                                <label><input :value="bet_mode._id"
                                                              type="checkbox" v-model="create_request.bet_modes"/> {{bet_mode.bet_name}}</label>
                                    </span>
    ...
    <jsp:attribute name="jslink">
        ...
        <script src="${contextPath}/app/controller/content/upload-bet-match.js" type="text/javascript"></script>
