...
<mt:masterpage title="Post Series management">
    <jsp:attribute name="content">
        <div id="posts-manager-root">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Post Series Management</h1>
                </div>
            </div>
            <div class="row">
                <form>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <input id="name-team-select"
                                       class="form-control" placeholder="Search team" v-model="posts_manager_select"/>
                            </div>
                        </div>
                    <div class="col-lg-6">
                        <button type="submit" class="btn btn-primary" v-on:click.prevent="onSearchClick">Search</button>
                        <button type="submit" class="btn btn-primary" v-on:click.prevent="onAddNewPostsManagerClick">Add
                            New PostManager
                        </button>
                    </div>
                </form>
            ...
            <div>
                <div v-for="item in items">
                    <posts-manager-item :post="item" v-on:deleted="deleteItem(item._id)"
    ...
    <jsp:attribute name="jslink">
       ...
       <script src="${contextPath}/js/bootstrap-datepicker.js" type="text/javascript"></script>
        ...
        <script src="${contextPath}/app/vue/posts-manager-item.js" type="text/javascript"></script>
        <script src="${contextPath}/app/controller/content/posts-management.js" type="text/javascript"></script>
    </jsp:attribute>
</mt:masterpage>
