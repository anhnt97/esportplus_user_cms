...
<mt:masterpage title="Upload Bet Match">
            ...
            <div style="padding-left: 30px">
                <div class="row" style="margin-top: 20px">
                    <form role="form">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class=" col-sm-8" v-for="linkstream in list_link_stream">
                                    <label>Link Stream</label>
                                    <input class="form-control" type="text" id="input_link" placeholder="Link Stream"
                                           maxlength="50" size="20" v-model="linkstream.link"
                                    >
                                </div>

                                <div class="footer" style="margin-top: 10px">
                                <span style="margin-top: 15px" class="btn btn-primary" v-on:click.prevent="onBtnAddStream">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-sm-4">
                                    ...
                                    <select style="width: auto" class="form-control" v-model.number="create_request.set" id="set_select">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <select style="width: auto" class="form-control" v-model.number="create_request.match" id="match_select">
                                        <option value="1" selected>1</option>
                                        <option value="2">2</option>
                                        <option value="3">3</option>
                                        <option value="4">4</option>
                                ...
                                <div class="col-sm-4">
                                    <label for="state_select">State Match</label>
    ...
    <jsp:attribute name="jslink">
        ...
        <script src="${contextPath}/app/controller/content/update-result-bet-match.js" type="text/javascript"></script>
